// Seed data for Sarvada Hospito Care — initial Firestore population
...
export async function seedDepartmentsAndServices() {
  ...
  console.log('✅ 5 Categories & Treatments seeded!')
}
