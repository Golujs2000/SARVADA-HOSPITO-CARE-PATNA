  ...
  return (
    <>
      <SEO
        ...
        description="Explore Sarvada Hospital's surgical specialities — advanced laparoscopy, kidney stones, gallbladder stone surgery, hernia repair, appendix, liver & pancreas care, and general surgical treatments in Patna, Bihar."
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="container-max">
          ...
          <p className="text-white/80 text-lg max-w-2xl mx-auto">
            {specialities.length > 0
              ? `${specialities.length} specialities · ${totalTreatments}+ treatments — all under one roof in Patna`
              : 'Comprehensive medical care across all major specialities in Patna, Bihar'}
          </p>
        </motion.div>
      </section>
